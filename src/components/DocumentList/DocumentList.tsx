  ...
  return (
    <>
      <Box>
        <TreeItem nodeId="1" label="Front-End">
          ...
          <TreeItem nodeId="3" label="React">
            ...
            <TreeItem nodeId="99" label="Basics" onClick={(e: React.MouseEvent<HTMLElement, MouseEvent>) => previewDocument(e)} />
            <TreeItem nodeId="100" label="PerformanceTuning" onClick={(e: React.MouseEvent<HTMLElement, MouseEvent>) => previewDocument(e)} />
      ...
      <Box sx={{ marginTop: '10%'}}>
        ...
        <TreeItem nodeId="29" label="types-cheat-sheet" onClick={(e: React.MouseEvent<HTMLElement, MouseEvent>) => previewDocument(e)} />
        </TreeItem>
      </Box>
    </>
  )
